{
  "Guid" : "BB32681F-DA7B-400D-87CE-6B395CE126EF",
  "Tags" : [
  ...
  "Smart Selection Rules" : [
    ...
    {
      "notes" : "Phabricator Link",
      "precision" : "very_high",
      "regex" : "([DP][0-9]+)",
      "actions" : [
        {
          "title" : "Open Phabricator",
          "action" : 1,
          "parameter" : "https:\/\/phabricator.intern.facebook.com\/\\1"
        }
      ]
    },
    {
      ...
      "actions" : [
        {
          "title" : "Open Task",
          "action" : 1,
          "parameter" : "https:\/\/our.intern.facebook.com\/intern\/tasks?t=\\1"
        }
      ]
    }
  ],
  ...
  "Transparency" : 0.1550411427514793,
  "Ansi 0 Color" : {
    "Green Component" : 0,
    "Red Component" : 0,
    "Blue Component" : 0
