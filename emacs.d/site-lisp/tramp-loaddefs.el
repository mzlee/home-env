...
;;;;;;  "tramp-adb" "tramp-adb.el" (20874 44572 0 0))
...
;;;;;;  "tramp-cache" "tramp-cache.el" (20874 44572 0 0))
...
;;;;;;  tramp-cleanup-connection) "tramp-cmds" "tramp-cmds.el" (20874
;;;;;;  44572 0 0))
...
;;;;;;  "tramp-gvfs" "tramp-gvfs.el" (20874 44572 0 0))
...
(defvar tramp-remote-process-environment `("HISTFILE=$HOME/.tramp_history" "HISTSIZE=1" "TMOUT=0" "LC_ALL=C" ,(format "TERM=%s" tramp-terminal-type) "EMACS=t" ,(format "INSIDE_EMACS='%s,tramp:%s'" emacs-version tramp-version) "CDPATH=" "HISTORY=" "MAIL=" "MAILCHECK=" "MAILPATH=" "PAGER=\"\"" "autocorrect=" "correct=") "\
...
;;;***

;;;### (autoloads nil "trampver" "trampver.el" (20874 44718 0 0))
...
;;;***

;;;### (autoloads nil nil ("tramp-compat.el") (20874 44719 107205
;;;;;;  0))
